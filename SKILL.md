...
description: "A股模拟盘系统 - 第一性原理设计，专注个人策略验证，系统与策略严格解耦，100%对齐实盘规则，核心拟合度优于行业平均，支持多策略并行运行，兼容所有基于BaseStrategy的现有策略，无需修改原策略代码"
version: "2.0.0"
author: "GroAries"
created: "2026-04-01"
updated: "2026-04-01"
metadata:
  category: "finance"
  tags: ["A股", "模拟盘", "回测", "交易", "实盘规则", "多策略", "策略适配"]
  requires: { "bins": [] }
  status: "active"
---
...
✅ 第一性原理设计，兼容所有现有策略（v2.0新增）：
- 通用策略适配层，无需修改任何原策略代码
- 100%兼容所有基于BaseStrategy的现有策略
- 多策略并行运行，每个策略独立账户，互不干扰
- 实时对比多个策略的交易结果和绩效
